...
# Save to existing file - test overwrite
existing_file = 'C:/Users/admin/.qclaw/workspace/marcus_report.png'
ts_file = 'C:/Users/admin/.qclaw/workspace/marcus_report_%s.png' % now.strftime('%Y%m%d_%H%M')
...
try:
    with open(existing_file, 'wb') as f:
        f.write(png_bytes)
    print('SAVED (overwrite): ' + existing_file)
except Exception as e:
    print('OVERWRITE FAILED: ' + str(e))

# Try new file
try:
    with open(ts_file, 'wb') as f:
        f.write(png_bytes)
    print('SAVED (new): ' + ts_file)
except Exception as e:
    print('NEW FILE FAILED: ' + str(e))

# Try existing file with PIL
try:
    img.save(existing_file, quality=95)
    print('PIL SAVE (overwrite): OK')
except Exception as e:
    print('PIL SAVE FAILED: ' + str(e))
