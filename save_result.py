...
try:
    ...
    d = resp.json()
    # save to temp without print
    out = json.dumps(d, ensure_ascii=False)
    with open('C:\\Users\\admin\\AppData\\Local\\Temp\\sresult.json', 'w', encoding='utf-8') as f:
        f.write(out)
except Exception as e:
    with open('C:\\Users\\admin\\AppData\\Local\\Temp\\sresult_err.txt', 'w') as f:
        f.write(str(e))
